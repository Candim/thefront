...
const getNumbers = () =>{
    setNumbers([
        ...
        {title :"30+", 
        description:"30 + stand-alone, fully customizable components designed by following Atomic Methodologies.",},
        {title :"45+", 
    ...
    return (
        <Container maxwidth="lg">
            <Grid container alignItems="center" spancing={8}>
                 <Grid item md={6}>
                 <Title text= "Less code. More speed"/>
                 <H3 text=" theFront is a simple, modular and 
                 accessible component library that gives you the building
                 blocks you need to build your React applic"/> 
                 ...
                 <H3 text=" Whether you're creating a subscription service, an on-demand
                  marketplace, an e-commerce store, or a portfolio showcase, theFront helps
